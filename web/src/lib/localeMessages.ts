...
export const englishMessages: Record<string, string> = {
  '읽기 기록 동기화': 'Reading notes sync',
  '읽기 기록이 다시 변경되었습니다. 최신 기록을 확인하고 다시 선택해 주세요.': 'This note changed again. Review the latest version and choose again.',
  '읽기 기록 · 연결 대기': 'Reading notes · Waiting for connection',
  '읽기 기록 · 동기화됨': 'Reading notes · Synced',
  '읽기 기록 · 기록 선택 필요': 'Reading notes · Choose a version',
  '읽기 기록 · 저장 대기': 'Reading notes · Pending',
  '읽기 기록 · 동기화 확인': 'Reading notes · Check sync',
  '읽기 기록 · 확인 중': 'Reading notes · Checking',
  '충돌 목록으로': 'Back to conflicts',
  '읽기 도구로': 'Back to reading tools',
  '저장 대기 {0}개 · 충돌 {1}개': '{0} pending · {1} conflicts',
  '이 기기의 기록': 'Note on this device',
  '서버의 기록': 'Note on the server',
  '삭제된 기록': 'Deleted note',
  '{0} 기록 보기': 'View note: {0}',
  '이 상태를 선택하면 항목이 삭제됩니다.': 'Choosing this version deletes the item.',
  '제목을 누르면 기록과 해당 문단을 확인할 수 있습니다.': 'Select the title to read the note and its paragraph.',
  '이 기기 기록 사용': 'Use this device version',
  '서버 기록 사용': 'Use server version',
  '두 기기에서 같은 기록을 변경했습니다.': 'Two devices changed this note.',
  '기록 비교': 'Compare versions',
  '서버 원문과 번역문의 북마크·강조·메모를 같은 계정의 앱과 웹에서 공유합니다.': 'Share bookmarks, highlights and notes for server originals and translations between the app and web using the same account.',
  '연결이 끊겨도 변경한 기록은 기기에 남습니다. 다른 기기와 충돌한 기록은 직접 선택할 때까지 보존합니다.': 'Changes stay on this device offline. Conflicting notes are preserved until you choose a version.',
  '이전 형식의 기록 {0}개는 이 기기와 ZIP 파일에 보존됩니다. 아직 계정 동기화 대상이 아닙니다.': '{0} notes in an older format are preserved on this device and in ZIP exports. They do not yet sync with your account.',
  '원문과 번역문의 기록은 각각 저장됩니다. 서버 문서를 삭제하면 연결된 기록도 삭제됩니다.': 'Original and translation notes are stored separately. Deleting a server document also deletes its notes.',
  '같은 계정의 앱과 웹에서 공유하는 읽기 기록입니다.': 'This note is shared between the app and web using the same account.',
  '읽기 기록 수정': 'Edit reading note',
  '수정 취소': 'Cancel editing',
  '기록의 위치와 강조 범위를 유지하며 제목과 메모를 수정합니다.': 'Edit the title and note while keeping the location and highlight range.',
  '이 읽기 기록을 삭제할까요?': 'Delete this reading note?',
  '동기화된 기록의 삭제는 같은 계정의 앱과 웹에도 반영됩니다.': 'Deleting a synced note also deletes it in the app and web using the same account.',
  '다른 기기에서 기록이 변경되었습니다. 최신 기록을 확인한 뒤 다시 수정해 주세요.': 'Another device changed this note. Review the latest version before editing again.',
  '읽기 기록을 동기화하려면 다시 로그인해 주세요.': 'Sign in again to sync reading notes.',
  '읽기 기록을 동기화할 권한을 확인할 수 없습니다.': 'Could not verify permission to sync reading notes.',
  '읽기 기록을 동기화할 서버 문서를 찾을 수 없습니다.': 'Could not find the server document for reading notes.',
  '다른 기기에서 읽기 기록이 변경되었습니다. 유지할 기록을 선택해 주세요.': 'Another device changed this note. Choose the version to keep.',
  '동기화할 읽기 기록을 확인해 주세요.': 'Check the reading note to sync.',
  '읽기 기록 변경 요청을 확인할 수 없습니다.': 'Could not verify the reading note change.',
  '읽기 기록 동기화 요청이 많습니다. 잠시 후 다시 시도해 주세요.': 'Too many reading note sync requests. Try again later.',
  '읽기 기록 변경 횟수가 서버 한도에 도달했습니다.': 'Reading notes reached the server revision limit.',
  '서버에서 읽기 기록을 처리하지 못했습니다.': 'The server could not process reading notes.',
  '서버에 연결할 수 없습니다. 변경한 읽기 기록은 기기에 보관됩니다.': 'Cannot connect to the server. Reading note changes stay on this device.',
  '읽기 기록 동기화 시간이 초과되었습니다.': 'Reading note sync timed out.',
  '읽기 기록 동기화가 취소되었습니다.': 'Reading note sync was cancelled.',
  '서버의 읽기 기록 응답을 확인할 수 없습니다.': 'Could not verify the server reading notes response.',
  '이 기기에 읽기 기록 변경을 보관하지 못했습니다.': 'Could not save reading note changes on this device.',
