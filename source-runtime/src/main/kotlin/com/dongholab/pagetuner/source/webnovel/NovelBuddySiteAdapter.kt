...
class NovelBuddySiteAdapter : WebNovelSiteAdapter {
    ...
    override suspend fun loadChapters(
        ...
        // A failed full index is not an empty/partial successful book. Cancellation
        // and provider failures must reach the host so it can retry explicitly.
        return NovelBuddyDomScraper.parseChapterIndex(fetchText(indexUrl), url).map(::chapter)
    }
